...
import { obtenerProductos } from '../../utils/getProducts'; 

const CollectionSection = () => {

  const [productos, setProductos] = useState([]);

  // Usamos la función obtenerProductos
  const fetchProductos = async () => {
    try {
      const productosArray = await obtenerProductos();  // Llamamos a la función importada
  ...
  useEffect(() => {
    fetchProductos();  // Llamamos a la función para obtener los productos cuando el componente se monta
  }, []);
    ...
    <section className="fz-1-latest-collection">
      <div className="container">
        <div className="fz-1-section-heading">
          <h2 className="fz-section-title">Ultimos Medicamentoss</h2>
        </div>
            ...
            >
              <div className="fz-single-product__img">
                ...
                <div className="fz-single-product__actions">
                  ...
                  >
                    <span className="btn-txt">Lista de deseos</span>
                  ...
                  >
                    <span className="btn-txt">añadir a la cesta</span>
                    <span className="btn-icon">
                  ...
                  <button className="fz-add-to-compare-btn">
                    <span className="btn-txt">seleccione para comparar</span>
                    <span className="btn-icon">
              ...
              <div className="fz-single-product__txt">
                ...
                <p className="fz-single-product__price">
                  <span className="current-price">Bs{item.price}</span>
                </p>
              </div>
            </SwiperSlide>
          ))}
        ...
        <Swiper
          slidesPerView={4}
          className="fz-1-products-container my-4"
          navigation={{
            prevEl: ".product-prev",
            nextEl: ".product-next",
          }}
